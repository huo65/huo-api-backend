package com.huo.huoapiadmin.controller;

import cn.hutool.json.JSONUtil;
import com.huo.huo_client_sdk.client.SimulateApiClient;
import com.huo.huoapiadmin.annotation.AuthCheck;
import com.huo.huoapiadmin.config.GatewayConfig;
import com.huo.huoapiadmin.exception.ThrowUtils;
import com.huo.huoapiadmin.service.InterfaceInfoService;
import com.huo.huoapiadmin.service.UserService;
import com.huo.huoapiadmin.exception.BusinessException;

import com.huo.huoapicommon.common.*;
import com.huo.huoapicommon.constant.CommonConstant;
import com.huo.huoapicommon.constant.UserConstant;
import com.huo.huoapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.huo.huoapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.huo.huoapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.huo.huoapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.huo.huoapicommon.model.entity.InterfaceInfo;
import com.huo.huoapicommon.model.entity.User;
import com.huo.huoapicommon.model.enums.InterfaceInfoStatusEnum;
import com.huo.huoapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        SimulateApiClient huoApiClient = interfaceInfoService.gethuoApiClient(request);
        // 设置网关地址
        huoApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = huoApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = huoApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
